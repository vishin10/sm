...
export const PARTIAL_DATE_EXTRACTION_PROMPT = (
    question: string,
    currentDate: string
) => `
...
export const DISAMBIGUATION_PROMPT = (
    question: string,
    matchingReports: Array<{ date: string; shifts: number; grossSales?: number }>
) => `
...
export const CORRECTION_DETECTION_PROMPT = (
    userMessage: string,
...
export const VERIFICATION_RESPONSE_PROMPT = (
    correction: any,
    actualData: any
) => `
...
export const APPLY_CORRECTION_PROMPT = (
    question: string,
    dataContext: any,
    correction: any
) => `
